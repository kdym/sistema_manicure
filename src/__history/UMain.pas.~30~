...
begin
  ...
  begin
    ...
    LbWarningStock.Caption := Format('Você possui %s %s acabando no estoque',
  ...
  begin
    ...
    begin
      Buffer := 'produto próximo';
    end
    else
    begin
      Buffer := 'produtos próximos';
    end;

    LbWarningEnd.Caption := Format('Você possui %s %s do vencimento',
  ...
  begin
    ...
    LbWarningExpired.Caption := Format('Você possui %s %s',
